...
function onConnect(socket) {
  ...
  require('../api/workshop/workshop.socket').register(socket);
  ...
  require('../api/customer_review/customer_review.socket').register(socket);
  require('../api/success_story/success_story.socket').register(socket);
